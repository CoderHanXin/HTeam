<template>
  <div :class="[prefixCls]">
    ...
    <slot name="tip"></slot>
    <UploadList v-if="showUploadList" :files="fileList" @on-file-remove="handleRemove" @on-file-preview="handlePreview"></UploadList>
  </div>
</template>
...
export default {
  ...
  methods: {
    ...
    handleChange(e) {
      ...
      uploadService.getToken().then(res => {
    ...
    handleProgress(res, file) {
      ...
      this.onProgress(res, _file, this.fileList)
    ...
    handleError(err, file) {
      ...
      this.onError(err, _file, this.fileList)
    },
    handleRemove(file) {
      const fileList = this.fileList
